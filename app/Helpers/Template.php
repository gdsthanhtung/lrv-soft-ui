...
class Template {
    ...
    // public static function showDropdownFilter($ctrl, $params, $enum = 'ruleStatus', $class = 'secondary', $filterName = 'status'Z){
    //     $html = $list = '';
    //     $rule = Config::get('gds.enum.'.$enum);

    //     foreach($rule as $key => $item){
    //         $name = $item['name'];
    //         $list .= sprintf('<li><a class="dropdown-item select-filter" data-value="%s" data-type="%s">%s</a></li>', $key, $filterName, $name);
    //     }
